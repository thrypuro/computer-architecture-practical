...
#
# Generated by export_simulation on Thu Oct 21 22:28:39 +0100 2021
#
################################################################################
...
'-reset_run' switch to the './rv32im_regfile_0.sh' script.

./rv32im_regfile_0.sh -reset_run
...
./rv32im_regfile_0.sh -noclean_files

For more information on the script, please type './rv32im_regfile_0.sh -help'.
